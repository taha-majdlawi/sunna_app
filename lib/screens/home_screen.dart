...
import 'package:sunaa_app/screens/notes_screens.dart';
...
class _HomeScreenState extends State<HomeScreen> {
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildEpisodeItem(
                    ep,
                    ep["number"].toString(),
                    ep["youtube_title"] ?? ep["title"],
                    lastReadEpisodeNumber == ep["number"].toString(),
                    colors,
                    index,
                  );
                },
  ...
  Widget _buildResumeCard(ThemeData theme, ColorScheme colors) {
    final last = episodes.firstWhere(
  ...
  Widget _buildListHeader(ThemeData theme) => Padding(
    ...
    child: Row(
      ...
      children: [
        Text("${filteredEpisodes.length} حديثاً"),
        const Text(
          "قائمة الأحاديث",
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text("كل الاستنباطات التي دونتها"),
            onTap: () {
